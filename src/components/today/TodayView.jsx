// Component: TodayView
// Purpose: Full daily command center — energy, greeting, mood, focus, progress, tasks, habits, water, gratitude, score, eod
...
export default function TodayView({ tasks, habits, notes, mood, intention, gratitude, water, score, monthlyLetter, energy }) {
